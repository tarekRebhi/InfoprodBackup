...
using MVCWEB.Models;
using Domain.Entity;
using static MVCWEB.Controllers.ManageController;
using Services;
...
namespace MVCWEB.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Dependency Injection via Constructor by imed.
        ...
        public async Task<ActionResult> Register(EmployeeViewModel model)
        {
            if (ModelState.IsValid)
            {
                //Utilisateur test = userService.getBylogin(model.userName);
                var user = new Employee { UserName = model.userName,role=model.role,pseudoName=model.pseudoName };
