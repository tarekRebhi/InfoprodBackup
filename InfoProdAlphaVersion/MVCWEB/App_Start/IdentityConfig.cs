...
namespace MVCWEB
{
    ...
    public class ApplicationUserManager : UserManager<Employee,int>
    {
        ...
        {
            ReportContext test = new ReportContext();
            var manager = new ApplicationUserManager(new CustomUserStore(test));
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<Employee,int>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<Employee,int>
            {
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<Employee,int>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
    public class ApplicationRoleManager : RoleManager<CustomRole, int>
    {
            ...
            IdentityFactoryOptions<ApplicationRoleManager> options, IOwinContext context)
        {
            return new ApplicationRoleManager(
                new CustomRoleStore(context.Get<ReportContext>()));
        }
    }
